...
exports.chromotome_palettes = void 0;
var misc = [
    {
        name: 'frozen-rose',
...
const pals = misc.concat(ranganath, roygbivs, tundra, colourscafe, rohlfs, ducci, judson, iivonen, kovecses, tsuchimochi, duotone, hilda);
exports.chromotome_palettes = pals.map((p) => {
    p.size = p.colors.length;
    return p;
});
//# sourceMappingURL=chromotome.js.map